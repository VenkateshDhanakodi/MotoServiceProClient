...
export const CoveredServices = ({ category, onBookServiceClick }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Initializing selectedServiceItems array with initial values based on the category
  ...
  const handleButtonClick = () => {
    // Calculating the total amount based on the selected services
    ...
    // Dispatching the action to update total amount in the order slice redux
    dispatch(setTotalAmount(totalAmount));

    // Triggering the parent component's function
...
export const selectedServiceItems = [];
